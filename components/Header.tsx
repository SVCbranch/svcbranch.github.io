...
export default function Header({ currentPage, onNavigate }: HeaderProps) {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 border-b border-white/5 bg-dark-bg/80 backdrop-blur-md">
      ...
      {/* Mobile Menu */}
      {isMenuOpen && (
        <div className="md:hidden animate-fade-in-down border-white/5">
          <div className="flex flex-col p-6 gap-4">
            ...
            <button 
              onClick={() => handleNavigate('home')}
              className="flex items-center justify-center gap-2 mt-4 px-6 py-4 rounded-xl bg-primary text-black font-bold transition-all"
            >
